...
String parse(String rawData, String usuario, String licencia) {
  try {
    ...
    //final _value = Utf8.toUtf8(rawData);
   // final _ptr = _value.cast<Int32>();
